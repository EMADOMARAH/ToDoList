...
public class Low_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view =inflater.inflate(R.layout.fragment_low_, container, false);
        return view;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        final AlertDialog.Builder alertDialog3 = new AlertDialog.Builder(getContext());
        alertDialog3.setTitle("Confirm Delete...");
        alertDialog3.setMessage("Are you sure you want delete this Note?");
        ...
        new Low_Fragment.getlow().execute();
                ...
                alertDialog3.setPositiveButton("YES",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                new Low_Fragment.Delete().execute(recyclerViewAdapter.getTaskAt(viewHolder.getAdapterPosition()));
    ...
    class getlow extends AsyncTask<Void,Void,List<taskModel>>
    {
        @Override
        protected List<taskModel> doInBackground(Void... voids) {
            list= appDataBase.taskDao().getlow();
            return list;
        }
